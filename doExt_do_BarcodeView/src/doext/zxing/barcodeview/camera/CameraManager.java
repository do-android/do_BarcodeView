...
//	private static final int MAX_FRAME_HEIGHT = 360;
	 ...
	 */
	public void openDriver(SurfaceHolder holder, int screenWidth, int screenHeight) throws IOException {
		if (camera == null) {
			camera = Camera.open();
			if (camera == null) {
			...
			if (!initialized) {
				initialized = true;
				configManager.initFromCameraParameters(camera, screenWidth, screenHeight);
			}
	...
	public void flash(boolean active) throws IOException {
